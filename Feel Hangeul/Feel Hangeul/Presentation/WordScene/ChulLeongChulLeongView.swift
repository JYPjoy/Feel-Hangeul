    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack(){
                VStack {
                    Spacer()
                    DetailWordView(word: "출렁출렁", meaning: "[Chul-Leong-Chul-Leong]", explanation: "▶︎ \"출렁출렁\" is used to describe waves or wind causing something to move gently back and forth in a rhythmic manner.", example: "▶︎ (ex) In Santa Monica Beach, you can see sea water is swaying 출렁출렁.")
                    Spacer()
