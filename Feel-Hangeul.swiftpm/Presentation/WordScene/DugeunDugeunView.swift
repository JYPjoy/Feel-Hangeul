    ...
    var body: some View {
        ZStack{
            ...
            VStack(){
                ...
                Spacer()
                DetailWordView(word: "두근두근", meaning: "[Du-Geun-Du-Geun]", explanation: "▶︎ \"두근두근\" is a Korean onomatopoeic word, which mimcs the sound of heart beating. \nPeople use this word when they feel thrilled or nervous.", example: "▶︎ (ex) Everyday I go to Apple Developer Academy at Postech, my heart go 두근두근, is filled with of joy.") //My heart went pit a pat.
                Spacer()
            }
        }
        .onAppear {
