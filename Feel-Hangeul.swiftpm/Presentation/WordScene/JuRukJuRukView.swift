...
struct JuRukJuRukView: View {
    ...
    var body: some View {
        ZStack{
            ...
            DetailWordView(word: "주룩주룩", meaning: "[Ju-Ruk-Ju-Ruk]", explanation: "▶︎ (ex) \"주룩주룩\" is a Korean mimetic word, which mimcs the sound of rain falling.", example: "▶︎ In Seattle, the rain is pouring down 주룩주룩 these days")
        }
        .toolbar {
